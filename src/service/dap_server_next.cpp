...
{
void dap_server::handle_next_request(const protocol::NextRequest &request)
{
    ...
    try
    {
        ...
        set_pending_stopped_event(protocol::StoppedEventBodyReason::Step, "Step completed.");
    ...
    send_response(request.seq, request.command, protocol::NextResponse{});
}
} // namespace dap_dbgeng::service
