...
{
void dap_server::handle_step_in_request(const protocol::StepInRequest &request)
{
    ...
    try
    {
        ...
        set_pending_stopped_event(protocol::StoppedEventBodyReason::Step, "Step in completed.");
    ...
    send_response(request.seq, request.command, protocol::StepInResponse{});
}
} // namespace dap_dbgeng::service
